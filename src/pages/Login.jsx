...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!usernameRegex.test(username))
      return setError('Username must start with a letter and be 3–16 characters.');
    ...
    if (!savedUser) return setError('No user found. Please register first.');
  ...
  return (
    ...
    >
      ...
      <Container style={{ width: '400px', margin: '100px auto' }} className="Container">
        <Form className="form" onSubmit={handleSubmit}>
          ...
          <p className="text-center mt-3">
            Don’t have an account? <NavLink to="/create">Register</NavLink>
          </p>
